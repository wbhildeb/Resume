...
\begin{rSection}{Projects}
    ...
    \begin{sideproject}
        ...
        {October 2019 - Present}
        {
            ...
            \item Collaborated with classmates, using leadership skills to assign roles and manage the project structure
            \item Structured the project to easily be extendible and allow new features such as locking playlists, track listening history, and monthly playlists with most listened songs
        }
    \end{sideproject}
...
\begin{rSection}{Academic \& Personal Achievements}
    ...
    \award{Multi-Instrumentalist (Guitar, Bass, Piano)}{ }\\
\end{rSection}
