...
\begin{rSection}{Education}
    ...
    Bachelor of Computer Science (88\% major avg) \hfill {\em President's Scholarship of Distinction}
...
\begin{rSection}{Work Experience}
    \begin{workexperience}
        ...
        {August 2021 - Present}
        {
            \item Implementing stream processing pipeline for analysis of network device status at incredible scale
            \item Re-evaluating current device analysis and prototyping new, more useful and efficient algorithms
        }
    \end{workexperience}
